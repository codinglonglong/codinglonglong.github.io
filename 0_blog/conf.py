...
BLOG_TITLE = "写程序的龙龙"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://codinglonglong.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://codinglonglong.github.io/"
BLOG_EMAIL = "codinglonglong@126.com"
BLOG_DESCRIPTION = "学习是运用一切资源充实自己的过程"  # (translatable)
...
# before </head>
# (translatable)
EXTRA_HEAD_DATA = """<script type="text/javascript">
    (function(c,l,a,r,i,t,y){
        c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};
        t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i;
        y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);
    })(window, document, "clarity", "script", "ew9g8uqr1q");
</script>"""
